var beginning = [
  ...
  {
    text: 'He described his grandfather as being his "great hero and protector”',
    criminal: "DennisNilsen",
    img: "images/baby-pictures/baby-nilsen.jpg",
    profile: "images/profile-pictures/nilsen.png",
  },
...

  {
    ...
    img: "images/baby-pictures/baby-theron.jpeg",
  ...
  {
    text: '“She lost consciousness after an unknown assailant drugged her drink; they then turned on the gas and closed the windows of her apartment”',
    criminal: "50Cent",
    img: "images/baby-pictures/baby-50cent.jpg",
    profile: "images/profile-pictures/50cent.png",
  },
...
var middle = [{
  ...
  {
    text: "When they asked why he drank liquor in class, he casually replied “It’s my medicine",
    criminal: "JeffreyDahmer",
    img: "images/baby-pictures/baby-dahmer.jpg",
    profile: "images/profile-pictures/dahmer.png",
  },
  ...
  {
    text: "He rescued a little three year old boy from drowning in Seatle’s Green Lake",
    criminal: "TedBundy",
    img: "images/baby-pictures/baby-bundy.jpg",
    profile: "images/profile-pictures/bundy.png",
  },
  ...
  {
    text: '"Girls were going behind my back, whispering that I was impotent. I was so ashamed”',
    criminal: "AndreiChikatilo",
    img: "images/baby-pictures/baby-chikatilo.jpeg",
    profile: "images/profile-pictures/chikatilo.png",
  },
  ...
  {
    text: '“she slapped him out of frustration, which caused him to start crying, prompting her to apologetically promise that violence will no longer be a part of their relationship”',
    criminal: "SeanVincentGillis",
    img: "images/baby-pictures/baby-gillis.jpg",
    profile: "images/profile-pictures/gillis.png",
  },
  ...
  {
    text: 'He spoke about his brother saying “There’s no doubt in my mind that if he had the opportunity to kill me, he would.”',
    criminal: "DouglasDurst ",
    img: "images/baby-pictures/baby-douglas-durst.jpg",
    profile: "images/profile-pictures/douglas-durst.png",
  },
  ...
  {
    text: '"All of my young and teenage years we lived in fear that my mother would be killed by my father.My father was violent both physically and verbally.”',
    criminal: "NickiMinaj",
    img: "images/baby-pictures/baby-minaj.jpg",
    profile: "images/profile-pictures/minaj.png",
  },
  ...
  {
    text: '"When I was not killing time in school, I was sparring in the gym or selling crack on the strip”',
    criminal: "50Cent",
    img: "images/baby-pictures/baby-50cent.jpg",
    profile: "images/profile-pictures/50cent.png",
  },
...
var end = [{
  ...
  {
    text: 'He managed to get a job as a salesperson for Xerox Corporation…',
    criminal: "HowardSchultz",
    img: "images/baby-pictures/baby-schultz.jpg",
    profile: "images/profile-pictures/schultz.png",
  },
  ...
  {
    text: 'He was in a friend’s basement when he was introduced to...',
    criminal: "50Cent",
    img: "images/baby-pictures/baby-50cent.jpg",
    profile: "images/profile-pictures/50cent.png",
  },
...
function positioning() {
  ...
  position = $(".text").last().offset().top + $(".text").last().height();
  $(".dot").last().css({
    top: position
  });
    ...
    if(currentProfile>0){
        ...
        $(".horizontal-line").last().css({
          ...
          width:0
            ...
            width:  $(".database:visible").width()*1.5
          },
          {
            duration: 1000,
            progress: function() {
              var position = $(".arrow-left").last().offset().left - $(".horizontal-line").last().width() + $(".database:visible").width() / 2;
...
// ---------------------------------- START Arrow right --------------------------------
  $(".arrow-right").click(function() {
    ...
    if(currentProfile<pickSave.length-1){
      currentProfile++;
      ...
      $(".horizontal-line").last().css({
        ...
        },
        {
          ...
          complete: function() {
            ...
            if(profileOrder<pickSave.length){
              var database = $("<div></div>").addClass("database");
...
// ---------------------------------- END Arrow right --------------------------------
  ...
  $("body").click(function(e){
    if($(e.target).not('.database')) {
      $(".informationImage").shows();
    
      $(".informationImage").css({right: $(".arrow-left").last().offset().left+1000});
    }// if e
  });
// ----- click on body -----
  $(".informationImage").click(function(e){
    
     
      $(".informationImage").hide();
